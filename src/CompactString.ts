...
const code_page_names: Array<
	'def' | 'ibm' | 'kamenicky' | 'latin1' | 'latin2'
> = ['def', 'ibm', 'kamenicky', 'latin1', 'latin2'];
...
export class CompactString {
	...
	next(): {
		...
		if (this._is_reading_emoji) {
			...
			return {
				value:
					String.fromCodePoint(this._emoji_being_read[1]) +
					String.fromCodePoint(this._emoji_being_read[2] | iterated_codepoint),
				done: this._is_done,
			};
			...
			if (
				(iterated_codepoint & 0b11100000) === 0b11000000 &&
				(this._data[this._read_index] & 0b11000000) === 0b10000000
			) {
				return {
				...
				(iterated_codepoint & 0b11110000) === 0b11100000 &&
				(this._data[this._read_index] & 0b11000000) === 0b10000000 &&
				(this._data[this._read_index + 1] & 0b11000000) === 0b10000000
			) {
				return {
					value: String.fromCodePoint(
				...
				(iterated_codepoint & 0b11111000) === 0b11110000 &&
				(this._data[this._read_index] & 0b11000000) === 0b10000000 &&
				(this._data[this._read_index + 1] & 0b11000000) === 0b10000000 &&
				(this._data[this._read_index + 2] & 0b11000000) === 0b10000000
			) {
				return {
					value: String.fromCodePoint(
